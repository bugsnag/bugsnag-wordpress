...
class Bugsnag_Wordpress {
	...
	private function constructBugsnag() {
		...
		if ( ! empty( $this->apiKey ) ) {
			...
			$this->client->mergeDeviceData( array( 'runtimeVersions' => array( 'wordpress' => get_bloginfo( 'version' ) ) ) );
	...
	/**
	 * [errorReportingLevel description]
	 *
	 * @return [type] [description]
	 */
	...
	/**
	 * Get Client IP Address Unsafe (Client can spoof address).
	...
	/**
	 * Get Client IP Address (Can not be spoofed, but can show ip of NAT or proxies).
	 *
	 * @return [type] [description]
	 */
	...
	/**
	 * [networkAdminMenuActions description]
	 *
	 * @return [type] [description]
	 */
	...
	/**
	 * [updateNetworkSettings description]
	 *
