...
class Bugsnag_Wordpress {
	 ...
	 * COMPOSER_AUTOLOADER
	 * 
	 * (default value: 'vendor/autoload.php')
	 * 
	 * @var string
	 * @access private
	 * @static
	 ...
	 * PACKAGED_AUTOLOADER
	 * 
	 * (default value: 'bugsnag-php/Autoload.php')
	 * 
	 * @var string
	 * @access private
	 * @static
	...
	/**
	 * networkAdminMenuActions function.
	 * 
	 * @access public
	 * @return void
	 */
	...
	/**
	 * updateNetworkSettings function.
	 * 
	 * @access private
